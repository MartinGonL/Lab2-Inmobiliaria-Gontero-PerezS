...
namespace Inmobiliaria_.Net_Core.Models
{
    public class RepositorioContrato : RepositorioBase, IRepositorioContrato
    {
        ...
        public int Alta(Contrato contrato)
        {
            ...
            {
                string sql = @"INSERT INTO contrato (id_inquilino, id_inmueble, monto_mensual, fecha_inicio, fecha_fin, creado_por, terminado_por)
                               VALUES (@idInquilino, @idInmueble, @montoMensual, @fechaInicio, @fechaFin, @creadoPor, @terminadoPor);
